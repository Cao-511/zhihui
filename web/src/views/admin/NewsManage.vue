<template>
  <div>
    <el-space direction="vertical" alignment="left" style="width: 100%">
      ...
      <el-card>
        <el-table ref="tableComponents"
          ...
          <el-table-column show-overflow-tooltip width="260" prop="title" label="标题"></el-table-column>
    ...
    >
      <el-form ref="formRef" :model="formData" label-width="100px">
        <slot name="content">
          <el-form-item label="图片" prop="image" style="width: 100%"
                        :rules="[{required:true,message:'不能为空',trigger:[ 'blur','change']}]">
            <MyUpLoad type="imageCard" :limit="1" :files="formData.image"
                      @setFiles="formData.image =$event"></MyUpLoad>
          </el-form-item>
          <el-form-item label="标题" prop="title"  >
  ...
  <DetailDialog
      ...
      @update:showDialog="val => isDialogVisible = val"
  />
</template>
...
function openDialog(id) {
  selectedNewsId.value = id || '默认ID'; // 根据实际需求设置ID
